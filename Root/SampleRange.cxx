...
namespace TD
{
  ...
  EL::StatusCode SampleRange :: initialize ()
  {
	...
	m_samples_lo_min->GetXaxis()->SetBinLabel (pmt + 1, buffer);
	m_samples_lo_max->GetXaxis()->SetBinLabel (pmt + 1, buffer);
	m_samples_hi_min->GetXaxis()->SetBinLabel (pmt + 1, buffer);
	m_samples_hi_max->GetXaxis()->SetBinLabel (pmt + 1, buffer);
      } // end pmt
